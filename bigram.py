...
def bigram_freq(text_file):
    ...
    # sorting
    bigram_freq_dict = dict(sorted(bigram_freq_dict.items(),
    ...
    for i in range(15):
        ...
        for idx, key in enumerate(list_keys):
            ...
            if score > max_score:
                ...
                actual_digest = hashlib.sha256(best_candidate.encode('utf-8'))
                actual_digest = actual_digest.hexdigest()
                ...
                # in the lucky case in which we find the real digest,
